...
#     assert EC.element_to_be_clickable(LOG_OUT), "Login failed, Log Out link is not present."
...
#     assert ("register" in driver.current_url), "User is not on the signup page"
...
# @allure.step("Add to Cart and Checkout")
# def test_add_to_cart(search_item):
...
#     test_add_to_cart(login_data['search'])
